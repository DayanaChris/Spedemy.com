...
<body class="learn_facial_expressions run-animation">
    ...
    <div  id="logo" class=" container " style=" margin-top: 0%;margin-bottom: 0%; " >
            <div class="container">
                <br>
                 <img  class="container logoanimation  pad log"  src="SPEDEMY/sub_menu/logo_facial_expressions.png"   > 
                 <div class="row">
                        <div class="col-sm-6   "  ><a href="/  "> <img class="card-img-top img-fluid zoom btn center"   src="SPEDEMY/sub_menu/btn_lesson.png" alt="Card image cap"></a> </div>
