        ...
        <div class="container-fluid" >
            ...
            <div id="myCarousel" class="carousel slide"  >
                ...
                <div class="item active " >
                        ...
                        <div class="container">
                                <div class="row">
                                        ...
                                        <div class="col-sm-4  " style="margin-top:10%">   <img class=" zoom letterA " src="SPEDEMY/Lessons/Alphabet/A/choice.png"  alt="Letter A"  ></div>
                                        <div class="col-sm-4  " style="margin-top:10%">   <img class="zoom letterA " src="SPEDEMY/Lessons/Alphabet/A/choice.png"  alt="Letter A"  ></div>
                                </div>
                        </div>
                </div>
              ...
              <a class="right carousel-control" href="#myCarousel" role="button" data-slide="next">
                ...
                <span class=" " aria-hidden="true"><img class="  card-img-top img-fluid zoom btn center back   " style=" width: 100%; margin-top:100%" src="SPEDEMY/Lessons/Alphabet/btn_right.png"   /> </span>
