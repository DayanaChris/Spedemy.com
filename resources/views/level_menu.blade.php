        ...
        {{-- </main> --}}
               ...
               <div class="containers" style=" margin-top: 0%;margin-bottom: 0%; " id="shad" >
                   <div class="card run-animation" style="background: skyblue; ">
                      <div class="card-header" style=" background:#FF1E9D"> <h2> <b> CHOOSE A LEVEL </b></h2></div>
                      @if(count($levels)>0)
                        <div class="row">
                          @foreach($levels as $level)
                              <div class="col-md-4">

                                   <a href="/levels/{{$level->level_id}}"> <img style="width:100%" src="/storage/level_image/{{$level->level_image}}" alt=""></a>
